...
export default function AboutPage() {
  ...
  return (
    <div className="seo-page-wrapper flair-style">
      ...
      <section className="two-cards-section about-page-cards-section about-story-section">
        <div className="seo-container-wide">
          <div className="about-cards-wrapper">
            {/* LEFT COLUMN: IMAGE PLACEHOLDER FROM PUBLIC FOLDER */}
            <motion.div
              className="about-cards-left-col"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.2 }}
              variants={fadeInUp}
            ...
            >
              <div className="about-image-card">
                <img
                  src="/Charac.webp"
                  alt="Blanc Media Strategy & Character"
                  className="about-side-img"
                />
                <div className="about-image-overlay">
                  <div className="about-img-badge">
                    <span className="dot-indicator orange">●</span>
                    <span>STRATEGY & CREATIVITY</span>
                  </div>
                  <div className="about-img-text">
                    <h4>Driven by Innovation</h4>
                    <p>Building meaningful connections that last.</p>
                  </div>
                </div>
              </div>
            </motion.div>

            {/* RIGHT COLUMN: STYLED CARD WITH HEADING AND CONTENT */}
            <motion.div
              className="about-cards-right-col"
              initial="hidden"
              whileInView="visible"
              ...
              <div className="dual-card light-grey-card about-story-card">
                <div className="dark-card-inner">
                  ...
                  <motion.h3
                    ...
                    custom={0.3}
                  >
                    Bold Strategy. Flawless Execution.
                  </motion.h3>
                </div>
              </div>
            </motion.div>
