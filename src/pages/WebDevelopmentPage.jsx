        ...
        <div className="seo-container">
          ...
          >
            <div className="seo-eyebrow-pill">
              ...
              <span className="seo-pill-text">04. WEBSITE DEVELOPMENT</span>
            </div>
            <h1 className="seo-hero-title">
              High Performance <br />
              <span className="seo-text-gradient">Web Engineering.</span>
            </h1>
            <p className="seo-hero-subtext">
              Modern, ultra-fast, responsive web applications built for high conversion and seamless user experience.
            </p>
            <a href="#contact" className="seo-primary-btn" style={{ marginTop: '1.5rem' }}>
              <span>Get Your Web Architecture</span>
