...
export default function Hero() {
  ...
  return (
    <section className="hero">
      ...
      {/* 2x2 Mobile Grid / Desktop Absolute Layer */}
      <div className="hero-cards-mobile-grid">
      ...
      <motion.div
        ...
        initial={{ opacity: 0, scale: 0.6, y: 85, x: "-50%", rotate: 0 }}
        whileInView={{ opacity: 1, scale: 1, y: 0, x: "-50%", rotate: 0 }}
        viewport={{ once: true }}
